                        ...
                        <div ref="pinInputContainerRef" class="relative w-full space-y-3">
                            <div class="flex w-full flex-col items-center justify-center space-y-3 py-2">
                                <PinInput id="otp" placeholder="○" v-model="form.code" type="number" otp>
                                    <PinInputGroup>
                                        <PinInputSlot autofocus v-for="(id, index) in 6" :key="id" :index="index" :disabled="form.processing" />
                                    </PinInputGroup>
                                </PinInput>
                            ...
                            <div class="flex w-full items-center space-x-5">
                                ...
                                <Button type="submit" class="w-auto flex-1" :disabled="form.processing || form.code.length < 6"> Confirm </Button>
                            </div>
                        </div>
                    </form>
                </template>
